...
class ScraperStartupHubCatalonia():
    ...
    def set_driver(self):
        '''This function set up all chrome drivers to run the code'''
    ...
    def get_startups(self):
        '''Main loop that iterates through all pages of startups'''
    ...
    def clean_data(self):
        '''This function performs some preliminary data cleaning'''
